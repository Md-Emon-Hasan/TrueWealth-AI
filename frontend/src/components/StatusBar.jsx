...
const StatusBar = () => {
    return (
        <div className="sticky top-0 z-30 w-full h-16 bg-white/80 dark:bg-card-dark/80 backdrop-blur-md flex items-center justify-between px-6 md:px-8 border-b border-gray-200 dark:border-white/5 shadow-sm transition-all">
